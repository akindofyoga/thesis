...
We evaluated our model pipelines using accuracy, which is the percentage of
...
This makes sense for a dataset like Imagenet, with 1000 different labels.
However, all of our models were trained on labels for a single subassembly.
Each was built in under 10 steps, so the models had fewer than 10 output labels.
