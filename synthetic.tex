...
The authors propose an improvement that would allow parts to be rendered with
different textures.
In addition, the authors propose to increase the variation in camera positions
