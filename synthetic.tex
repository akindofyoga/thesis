...
Meccano kit, for both real and synthetic data.
...
Each image must be classified as one label.
Thus models trained to classify images of the toy plane assembly must choose the
correct label from 10 choices, while models trained to classify images of the
Meccano assembly only have to choose the correct label from 5 choices.
...
As with the toy plane, this kit was born digitially, and we had access to the
...
\begin{tabular}{|l||l|l|}
\hline
  Software Used & Training Set Size & Accuracy\\
  \hline
  \hline
  Unity & 50,000 & 85\%\\
  \hline
...
resulting in models that were 7.85\% more accurate than the Unity images.
