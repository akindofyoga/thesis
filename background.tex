...
\hl{
  ...
  application.
  The next are experts, who are familiar with the tasks, and mistakes a user
  might make.
...
\hl{
  We follow the lead of {\cite{gebru2017finegrained}}, who used a two step
...
\hl{Our work is not the first to use object detection models for task beyond
detecting the object in an image and providing their coordinates.}
