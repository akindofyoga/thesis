...
\begin{figure}[h]
  ...
  \caption{
    The workflow for requesting help from a human expert with a WCA application
...
\begin{figure}[h]
  ...
  \end{captiontext}
  \caption{
    The PDFs for the distributions that Simulation 1 sampled times from
...
\begin{figure}[h]
  ...
  \end{captiontext}
  \caption{
    The PDFs for the distributions that Simulation 2 sampled times from
...
\begin{table}
  ...
  \end{tabular}
  \caption{
    Parameter values for the distributions that Simulation 2 sampled from
...
\begin{table}
  ...
  \end{tabular}
  \caption{
    Parameter values for the distributions that Simulation 3 sampled from
...
Fitting a linear model to these values achieves an $R^2$ coefficient of 0.81.
