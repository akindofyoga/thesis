...
The amounts of time in between sequential entrance times (which well will
...
\begin{figure}[H]
  ...
  \caption{
    ...
    Thus there is a large gap between the points along the best fit line in this
    figure.
  }\label{fig:gof}
\end{figure}
