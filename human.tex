...
WCA applications might be licensed to be used by a certain number of people at
any given time.
...
saying that the organization only paid for a license 10 active users.
...
However, if a user attempts to being the task while the number of active users
is equal to the limit, this user will not begin the task and they will leave the
simulation.
