...
step.
In addition, it is unclear whether suggesting that a user should call the expert
will be necessary in the first place.
Users have the option to call the expert at any time with our applications.
Figure~\ref{fig:design_space} shows options for expert-assisted task guidance
systems.
