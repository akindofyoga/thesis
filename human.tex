...
This strong fit indicates that the waiting times from the simulation are well
correlated with the waiting times from the formula.
...
\begin{figure}[h]
  ...
  \end{captiontext}
  \caption{
    The average wait time that resulted from changing the proportion of feasible
    steps.
...
\begin{figure}[h]
  ...
  \end{captiontext}
  \caption{
    The average wait times resulting from Simulation 4
