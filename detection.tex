...
into sub-assemblies.
The lower bound of ten comes from our firsthand experience developing WCA
applications.
...
We have integrated
Labeling videos with CVAT and removing frames with identical perceptual hash
vales are both part of the Ajalon toolchain.
...
\begin{figure}
  ...
  \caption{
    ...
    The sequences of steps in the white rectangle ([A-1, A-2] and [A-3, A-4])
    are repeated.
