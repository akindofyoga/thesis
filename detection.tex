...
assembly in order to get the classifier to assign the correct label to the
captured images of the assembly.
...
task has been completed.
They must also train the models to recognize each error state that they want the
...
assemblies as a
hierarchy\footnote{\url{https://knowledge.autodesk.com/support/inventor-products/learn-explore/caas/CloudHelp/cloudhelp/2015/ENU/Inventor-Help/files/GUID-9C1118A3-7EEB-4479-AEF7-BCA37F9F907F-htm.html}}
\footnote{\url{https://docs.hexagonppm.com/r/en-US/Intergraph-Smart-3D-Planning/Version-2016-11.0/60340}}.
...
\begin{figure}
  ...
  \begin{subfigure}{\textwidth}
    ...
    images in \ref{fig:perceptual_hash_identical}}
  \end{subfigure}
...
repositioning, but we chose to made step B-1 the start of a new subassembly
while we did not make step B-4 the start of a new subassembly.
None of our applications had a step that involved adding a part to the object
...
You can create a new training set that includes test images that were classified
incorrectly, then train a new model using this set.
