...
The distance between camera and the object being assembled will change how large
a subassembly appears in the image.
Techniques such as image compression or DNN-based split computing vary less
based on the specific content in the image.
...
latency bound with some of the pipelines that we tested.
...
However, these models were often less accurate than the DNNs that can only be
run on cloudlets.
